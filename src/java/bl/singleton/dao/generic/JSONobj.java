...
public class JSONobj
{
    ...
    {
        JsonObject dev = Json.createObjectBuilder().add("developer", "duke").build();
    ...
    public static JsonObject Test(JsonObject obj, String key, String value)
    {
        JsonObjectBuilder builder = Json.createObjectBuilder();
        builder.add(key, value);
    ...
    public static void writingJSONDataUsingGenerator() throws IOException
    {
